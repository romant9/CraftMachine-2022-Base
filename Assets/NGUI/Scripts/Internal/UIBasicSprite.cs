...
public abstract class UIBasicSprite : UIWidget
{
	...
	[HideInInspector]
	[SerializeField]
	protected bool mApplyHorizontalGradient;

	[HideInInspector]
	[SerializeField]
	protected Color mGradientLeft = Color.white;

	[HideInInspector]
	[SerializeField]
	protected Color mGradientRight = new Color(0.7f, 0.7f, 0.7f);

	[HideInInspector]
	[SerializeField]
	protected bool snapOnChange;
	...
	protected void SimpleFill(List<Vector3> verts, List<Vector2> uvs, List<Color> cols, ref Vector4 v, ref Vector4 u, ref Color c)
	{
		...
		if (!mApplyGradient && !mApplyHorizontalGradient)
		{
			cols.Add(c);
			cols.Add(c);
			cols.Add(c);
