...
public abstract class UIRect : MonoBehaviour
{
	...
	public class AnchorPoint
	{
		...
		public Vector3[] GetSidesMy(Transform relativeTo)
		{
			if (target != null)
			{
...
//#endif
	...
	public UIPanel ParentPanel { get; protected set; }

	protected virtual void OnEnable ()
	{
//#if UNITY_EDITOR
		if (NGUIManager.IsEditor) mEnabled = true;
//#endif
		mUpdateFrame = -1;
	...
	{
//#if UNITY_EDITOR
		if (NGUIManager.IsEditor) mEnabled = false;
//#endif
