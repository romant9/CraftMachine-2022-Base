...
public class UIProgressBar : UIWidgetContainer
{
	...
	public virtual void ForceUpdate()
	{
		...
		if (mBG != null)
		{
			UIBasicSprite uIBasicSprite2 = mBG as UIBasicSprite;
			if (uIBasicSprite2 != null && uIBasicSprite != null && uIBasicSprite2.invert != uIBasicSprite.invert && uIBasicSprite2.type == UIBasicSprite.Type.Filled && uIBasicSprite.type == UIBasicSprite.Type.Filled)
			{
				uIBasicSprite2.fillAmount = 1f - uIBasicSprite.fillAmount;
			}
		}
