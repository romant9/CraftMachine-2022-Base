...
public class UICamera : MonoBehaviour
{
	...
	public static GameObject selectedObject
	{
		...
		set
		{
			...
			if (value != null)
			{
				if (value.GetComponent<UIKeyNavigation>() != null)
				{
					controller.current = value;
				}
				else if (value.GetComponent<UIInput>() != null)
				{
					controller.current = value;
				}
			}
	...
	private void Update()
	{
		if (!ignoreAllEvents && handlesEvents && processEventsIn == ProcessEventsIn.Update && gameObject.activeSelf)
		{
			ProcessEvents();
		}
	}
