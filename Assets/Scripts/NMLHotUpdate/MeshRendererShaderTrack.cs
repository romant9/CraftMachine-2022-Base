...
public class MeshRendererShaderTrack : TrackAsset
{
	...
	{
		ScriptPlayable<MeshRendererShaderMixer> scriptPlayable = ScriptPlayable<MeshRendererShaderMixer>.Create(graph, inputCount);
