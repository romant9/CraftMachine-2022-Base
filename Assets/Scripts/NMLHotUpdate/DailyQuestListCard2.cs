...
public class DailyQuestListCard2 : UIListCard<DailyQuestItemModel>
{
	public delegate void SelectedCardDelegate(DailyQuestListCard2 card);
	...
	public void GetRewardIconAndAmount(out string rewardIconName, out int rewardAmount)
	{
		...
		{
			rewardIconName = "Ui_Icon_Quest_Trophy";
	...
	public void OnClaimRewardClick()
	{
		if (base.Item.IsCompleted)
		{
			...
			Helpers.ExecuteCommand(new ClaimDailyQuestCommand(base.Item.ModelId));
			UpdateUI();
		}
	}
}
