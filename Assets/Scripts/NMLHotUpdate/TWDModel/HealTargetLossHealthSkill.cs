namespace TWDModel
{
	public sealed class HealTargetLossHealthSkill : BaseCommandSkill
	{
		...
		public override CommandSkillType Type => CommandSkillType.CommandSkillHealTargetLossHealth;

		public HealTargetLossHealthSkill()
		{
		}

		public HealTargetLossHealthSkill(HealTargetLossHealthSkill skill)
			: base(skill)
		{
		...
		public HealTargetLossHealthSkill(FixedPoint parameter0, int parameter1, int parameter2, FixedPoint parameter3, int parameter4)
		{
		...
		public override void OnExecute(GridCoordinate targetCell)
		{
			...
			if (occupier != null)
			{
				...
				int amountHealed = (int)((occupier.MaxHitPoints - occupier.Hitpoints) * Parameter0) + Parameter1;
