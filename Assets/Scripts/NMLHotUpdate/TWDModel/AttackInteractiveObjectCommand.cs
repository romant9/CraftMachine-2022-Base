...
namespace TWDModel
{
	public class AttackInteractiveObjectCommand : ModelCommand
	{
		public int TargetId { get; set; }

		public AttackInteractiveObjectCommand()
		{
		}

		public AttackInteractiveObjectCommand(ActorModel actor, InteractiveObjectModel target)
			: base(actor)
		{
		...
		{
			bool num = manager.ExecuteAction(new AttackInteractiveObjectAction(actor, target));
			if (num)
			{
				actor.EndAction();
			}
