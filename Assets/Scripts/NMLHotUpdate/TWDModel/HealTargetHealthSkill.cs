namespace TWDModel
{
	public sealed class HealTargetHealthSkill : BaseCommandSkill
	{
		...
		public override CommandSkillType Type => CommandSkillType.CommandSkillHealTargetHealth;

		public HealTargetHealthSkill()
		{
		}

		public HealTargetHealthSkill(HealTargetHealthSkill skill)
			: base(skill)
		{
		...
		public HealTargetHealthSkill(FixedPoint parameter0, int parameter1, int parameter2, FixedPoint parameter3, int parameter4)
		{
		...
		public override void OnExecute(GridCoordinate targetCell)
		{
			...
			if (occupier != null)
			{
				...
				int amountHealed = (int)(occupier.Hitpoints * Parameter0) + Parameter1;
