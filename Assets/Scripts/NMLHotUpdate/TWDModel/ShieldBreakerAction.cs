...
namespace TWDModel
{
	public class ShieldBreakerAction : StatusEffectAction
	{
		public int Turns { get; private set; }

		public bool IgnoreSourceBeingDead { get; private set; }

		public ShieldBreakerAction(ActorModel sourceActor, ActorModel targetActor, int turns, bool ignoreSourceBeingDead = false, SupportModel sourceSupport = null, Func<int> damage = null)
		...
		public override bool Execute(ModelManager manager)
		{
			...
			if (combatModel != null && base.SourceActor != null && base.SourceActor.IsValid() && base.TargetActor != null && base.TargetActor.IsValid())
			{
				...
				{
					base.TargetActor.StartShieldBreaker(Turns, base.SourceActor);
				}
				return true;
			}
			(manager as TWDModelManager).Debug.LogError("ShieldBreaker action failed - CombatModel: " + ((combatModel != null) ? "not null" : "NULL") + " Source Actor: " + ((base.SourceActor != null) ? "not null" : "NULL") + " Target Actor: " + ((base.TargetActor != null) ? "not null" : "NULL"));
			return false;
		}
