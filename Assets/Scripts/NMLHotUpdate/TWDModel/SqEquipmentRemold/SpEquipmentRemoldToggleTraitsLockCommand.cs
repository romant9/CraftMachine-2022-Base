...
{
	public class SpEquipmentRemoldToggleTraitsLockCommand : ConsumeCurrencyCommand
	{
		public new int ModelId { get; set; }

		public string RemoldTraits { get; set; }

		public SpEquipmentRemoldToggleTraitsLockCommand()
		{
		}

		public SpEquipmentRemoldToggleTraitsLockCommand(string remoldTraits, int modelId)
		{
		...
		public override IModelCommandRespond Execute(ModelManager manager)
		{
			...
			if (model.SpEquipmentRemoldModel.LockTrait(RemoldTraits))
			{
