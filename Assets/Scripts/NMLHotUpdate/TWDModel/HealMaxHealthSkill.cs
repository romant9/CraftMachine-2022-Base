namespace TWDModel
{
	public sealed class HealMaxHealthSkill : BaseCommandSkill
	{
		...
		public override CommandSkillType Type => CommandSkillType.CommandSkillHealMaxHealth;

		public HealMaxHealthSkill()
		{
		}

		public HealMaxHealthSkill(HealMaxHealthSkill skill)
			: base(skill)
		{
		...
		public HealMaxHealthSkill(FixedPoint parameter0, int parameter1, int parameter2, FixedPoint parameter3, int parameter4)
		{
		...
		public override void OnExecute(GridCoordinate targetCell)
		{
			...
			if (occupier != null)
			{
				...
				int amountHealed = (int)(base.OwnActorModel.MaxHitPoints * Parameter0) + Parameter1;
