...
namespace TWDModel
{
	public class TauntAction : StatusEffectAction
	{
		...
		public TauntAction(ActorModel sourceActor, ActorModel targetActor, int turns, bool ignoreSourceBeingDead = false, SupportModel sourceSupport = null, Func<int> damage = null)
		...
		public override bool Execute(ModelManager manager)
		{
			...
			if (combatModel != null && base.SourceActor != null && base.SourceActor.IsValid() && base.TargetActor != null && base.TargetActor.IsValid())
			{
				...
				{
					base.TargetActor.Taunt(Turns, base.SourceActor);
					tWDModelManager.ExecuteAction(new PostStatusEffectAction(base.SourceActor, base.TargetActor, TimedEffectType.Taunt, base.SourceSupport, Turns, CausedByTrait));
				}
				return true;
			}
