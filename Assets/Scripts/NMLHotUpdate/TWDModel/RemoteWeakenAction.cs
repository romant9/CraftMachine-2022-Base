...
namespace TWDModel
{
	public class RemoteWeakenAction : StatusEffectAction
	{
		public int Turns { get; private set; }

		public bool IgnoreSourceBeingDead { get; private set; }

		public RemoteWeakenAction(ActorModel sourceActor, ActorModel targetActor, int turns, bool ignoreSourceBeingDead = false, SupportModel sourceSupport = null, Func<int> damage = null)
		...
		public override bool Execute(ModelManager manager)
		{
			...
			if (combatModel != null && base.SourceActor != null && base.SourceActor.IsValid() && base.TargetActor != null && base.TargetActor.IsValid())
			{
				...
				{
					base.TargetActor.StartRemoteWeaken(Turns, base.TargetActor);
				}
				return true;
			}
			(manager as TWDModelManager).Debug.LogError("Remote Weaken action failed - CombatModel: " + ((combatModel != null) ? "not null" : "NULL") + " Source Actor: " + ((base.SourceActor != null) ? "not null" : "NULL") + " Target Actor: " + ((base.TargetActor != null) ? "not null" : "NULL"));
			return false;
		}
