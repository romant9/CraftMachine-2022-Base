namespace TWDModel
{
	public sealed class HealDamageSkill : BaseCommandSkill
	{
		...
		public override CommandSkillType Type => CommandSkillType.CommandSkillHealDamage;

		public HealDamageSkill()
		{
		}

		public HealDamageSkill(HealDamageSkill skill)
			: base(skill)
		{
		...
		public HealDamageSkill(FixedPoint parameter0, int parameter1, int parameter2, FixedPoint parameter3, int parameter4)
		{
		...
		public override void OnExecute(GridCoordinate targetCell)
		{
			...
			if (occupier != null)
			{
				...
				int amountHealed = (int)((base.OwnActorModel as SurvivorModel).GetDamageForPreferredWeapon() * Parameter0) + Parameter1;
