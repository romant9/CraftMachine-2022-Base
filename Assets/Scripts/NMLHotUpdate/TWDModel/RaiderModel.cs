...
namespace TWDModel
{
	public class RaiderModel : ActorModel
	{
		...
		public RaiderVisualization VisualVariation { get; set; }
		...
		public override void ConfigureBaseAttributes()
		{
			...
			rangedDamageModifier = new AbilityModifierIncrementer("AddRangedDamage", num5);
