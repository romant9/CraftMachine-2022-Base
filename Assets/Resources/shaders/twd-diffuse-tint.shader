	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float4 temp_output_2_0 = ( _Color * tex2D( _MainTex, uv_MainTex ) );
				
				o.Albedo = temp_output_2_0.xyz;
				o.Normal = fixed3( 0, 0, 1 );
				o.Emission = ( temp_output_2_0 * 0.5 ).xyz;
				#if defined(_SPECULAR_SETUP)
...
ASEEND*/
//CHKSM=52FAD286DB8BE41C99E12C1A7E8A05C6C9E5AD26